  ...
  return (
    <section className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-700">Upload your conversation.json file to analyze water consumption</p>
      </div>
      ...
      >
        <input {...getInputProps()} aria-label="Upload conversation JSON file" />
